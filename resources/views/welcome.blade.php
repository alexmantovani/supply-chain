...
<body class="leading-normal tracking-normal gradient" style="font-family: 'Source Sans Pro', sans-serif; color: #A62F28">
    <!--Nav-->
    <nav id="header" class="fixed w-full z-30 top-0 text-white " style="background-color: #A62F28">
        <div class="w-full flex items-center justify-between mt-0 py-2">
            ...
            <div class="mt-0 pr-4 " id="nav-content">
                @if (Route::has('login'))
    ...
    <div class="pt-24">
        <div class="container px-3 mx-auto md:flex items-center justify-center md:space-x-5">
            <div class="md:flex md:flex-col md:w-3/5 justify-center md:justify-end items-center rounded shadow-xl">
                <img class="rounded-xl shadow-xl" src="{{ url('/images/logo_mg.png') }}" alt="" height=170>
            </div>
        </div>
    </div>
