...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
        ...
        <div class="container max-w-5xl mx-auto m-8">
            <div class="flex flex-wrap">
                <div class="w-full sm:w-1/2 p-6">
                    <img class="w-full md:w-4/5 z-50 rounded-xl shadow-lg" src="{{ url('/images/picking-list.jpg') }}"
                        alt="" height=170>
                </div>
                ...
                <div class="w-5/6 sm:w-1/2 p-6">
                    ...
                    <p class="text-gray-600 mb-8 leading-normal text-lg">
                        ReFiller permette la gestione delle liste di prelievo tramite l’uso di uno smartphone.
                        Dopo aver inserito gli articoli in esaurimento, è possibile generare automaticamente delle liste
                        di prelievo direttamente
                        inserendo gli articoli attraverso la lettura del codice a barre o ricercandoli per codice o
                        descrizione.
                    </p>
                </div>
            </div>
    ...
    <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
            <div class="flex flex-wrap">
                ...
                <div class="w-full sm:w-1/2 p-6">
                    <img class="w-full md:w-4/5 z-50 rounded-xl shadow-lg"
                        src="{{ url('/images/phone_scanner.jpg') }}" alt="" height=170>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
            <div class="flex flex-wrap">
                <div class="w-full sm:w-1/2 p-6">
                    <img class="w-full md:w-4/5 z-50 rounded-xl shadow-lg" src="{{ url('/images/screenshot_1.png') }}"
                        alt="" height=170>
                </div>

                <div class="w-5/6 sm:w-1/2 p-6">
                    <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                        Meno scorte, nessun esaurimento
                    </h3>
                    <p class="text-gray-600 mb-8">
                        Grazie ad un controllo puntuale e ad un invio degli ordini completamente automatizzato, le
                        scorte del tuo magazzino potranno essere ridotte al minimo.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto flex flex-wrap py-4">
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col ">
                <div class="flex-1 bg-white dark:bg-gray-900">
                    <div class="w-full text-gray-800 dark:text-gray-200 p-3">
                    ...
                    <div class="w-full font-bold text-xl text-gray-800 dark:text-gray-200 px-3">Scorte aggiornate</div>
                    <p class="text-gray-600 dark:text-gray-400 text-base px-3 mb-5">
                        Situazione scorte sempre aggiornata: Avrai sempre piena visibilità della merce in arrivo, dei
                        prodotti esauriti o quelli da riordinare. </p>
                </div>
            </div>
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col ">
                <div class="flex-1 bg-white dark:bg-gray-900">
                    ...
                    <div class="w-full font-bold text-xl text-gray-800 dark:text-gray-200 px-3">Codici a barre</div>
                    <p class="text-gray-600 dark:text-gray-400 text-base px-3 mb-5">
                        Stampa etichette personalizzate e utilizza lettori di codice a barre o
                        smartphone per rendere più efficiente il tuo lavoro.</p>
                </div>
            </div>
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col ">
                <div class="flex-1 bg-white dark:bg-gray-900">
                    ...
                    <div class="w-full font-bold text-xl text-gray-800 dark:text-gray-200 px-3">Totale integrazione
                    </div>
                    <p class="text-gray-600 dark:text-gray-400 text-base px-3 mb-5">
                        Grazie ai nostri plugin personalizzati, Refiller potrà integrarsi perfettamente col tuo
                        programma di gestione del magazzino o dei tuoi
                        ordini.
                    </p>
                </div>
            </div>
    ...
    <section class="bg-gray-100 py-8">
        <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
            ...
            <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Prezzi</h1>
            ...
            <div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
                <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                    <div class="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                        ...
                        <ul class="w-full text-center text-sm">
                            <li class="border-b py-4">1 utente</li>
                            <li class="border-b py-4">2 ordini al mese</li>
                            <li class="border-b py-4">10 prodotti a listino</li>
                        </ul>
                    </div>
                ...
                <div
                    ...
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                        ...
                        <ul class="w-full text-center text-base font-bold">
                            <li class="border-b py-4">50 utenti</li>
                            <li class="border-b py-4">50 ordini al mese</li>
                            <li class="border-b py-4">1.000 prodotti a listino</li>
                        </ul>
                    </div>
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                        <div class="w-full pt-6 text-4xl font-bold text-center">€ 9 <span class="text-base">/ al
                                mese</span></div>
                        <div class="flex items-center justify-center">
                            <x-secondary-button class="my-6 py-4 px-8 shadow-lg">
                                Registrati
                ...
                <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                    <div class="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                        ...
                        <ul class="w-full text-center text-sm">
                            <li class="border-b py-4">50.000 utenti</li>
                            <li class="border-b py-4">10.000 ordini al mese</li>
                            <li class="border-b py-4">100.000 prodotti a listino</li>
                        </ul>
                    </div>
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                        <div class="w-full pt-6 text-3xl text-gray-600 font-bold text-center">€ 29 <span
            ...
            <div class="text-center text-gray-600">
                Sei una grande azienda e vuoi piano personalizzato?
                <span class="font-semibold cursor-pointer text-gray-800 hover:underline">
                    Contattaci ora
                </span>
            </div>
    ...
    <footer class="bg-white">
        <div class="container mx-auto px-8">
            <div class="w-full flex flex-col md:flex-row py-3">
                <div class="flex">
                    <span style="" class=" text-gray-500 pr-3">Seguici su</span>

                    <a style="margin-right: 30px;" href="https://www.facebook.com/CoopAlleanza30/?fref=ts">
                        <!DOCTYPE svg
                            PUBLIC '-//W3C//DTD SVG 1.1//EN' 'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'><svg
                            height="100%"
                            style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;"
                            version="1.1" viewBox="0 0 512 512" width="100%" xml:space="preserve"
                            class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" xmlns:serif="http://www.serif.com/"
                            xmlns:xlink="http://www.w3.org/1999/xlink">
                            <path
                    ...
                    <a href="">
                        ...
                        <!DOCTYPE svg
                            ...
                            <g id="g5891">
                                ...
                                <g id="shapes">
                                    <rect height="257.962" id="rect11" style="fill:#fff;" width="85.76"
                                        x="61.053" y="178.667" />
                                    <path
                ...
                <div class="flex-1 text-right">
                    <p class="uppercase text-gray-500">Alex Mantovani &nbsp; © &nbsp; 2023</p>
                </div>
            </div>
        </div>
    </footer>
