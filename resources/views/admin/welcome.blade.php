<x-app-layout>
    ...
    <section class="justify-center antialiased bg-gray-100 text-gray-600 min-h-screen p-4 dark:bg-gray-800">
        <div class="grid grid-cols-4 gap-4 h-full mx-28">
            ...
            <a href="{{ url('admin/user') }}">
                <div
                    ...
                    <div class="flex justify-between">
                        <img class="w-16 h-16" src="{{ url('/images/users.png') }}" alt="">
            ...
            <a href="{{ route('admin.product.index', $warehouse) }}">
                <div
                    class="w-full max-w-7xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200 px1 md:p-8 dark:bg-gray-900 dark:border-gray-800">
                    <div class="flex justify-between">
                        <img class="w-16 h-16" src="{{ url('/images/product.png') }}" alt="">
            ...
            <a href="{{ url('/admin/dealer') }}">
                <div
                    ...
                    <div class="flex justify-between">
                        ...
                        <img class="w-16 h-16" src="{{ url('/images/shop.png') }}" alt="">
            ...
            <a href="{{ url('/admin/provider') }}">
                <div
                    ...
                    <div class="flex justify-between">
                        ...
                        <img class="w-16 h-16" src="{{ url('/images/truck.png') }}" alt="">
