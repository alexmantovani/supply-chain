            ...
            <div class="w-full max-w-7xl mx-auto pt-5">
                <div
                    ...
                    <div class="pb-6 md:m-5 flex space-x-4 justify-between items-center">
                        ...
                        <div>
                            <form method="GET" action="{{ route('provider.show', [$provider]) }}">
                            ...
                            @foreach ($provider->orders as $order)
                                <tr class="align-middle h-8">
                                    ...
                                    {{-- <td class="p-1 md:p-2 w-2">
                                        <div>
                                            <x-product-status-ball class="w-2 h-2"
                                                :status="$order->status" title="{{ $order->status->description }}" />
                                        </div>
                                    </td> --}}
                                    <td class="p-1">
                                        <x-product-name-cell :href="route('warehouse.order.show', [$warehouse, $order])">
                                            {{ $order->name }}
                                        </x-product-name-cell>
                                    </td>
                                    <td class="p-1 text-right hidden md:table-cell">
